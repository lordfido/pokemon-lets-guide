...
// Mobile
const MOBILE = getMinMediaQuery(320);
const MAX_MOBILE = getMaxMediaQuery(479);
...
const MAX_MOBILE_XL = getMaxMediaQuery(589);
export const MOBILE_XXL = getMinMediaQuery(590);
const MAX_MOBILE_XXL = getMaxMediaQuery(719);

// Tablet
export const TABLET = getMinMediaQuery(720);
const MAX_TABLET = getMaxMediaQuery(967);
